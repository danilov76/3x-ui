...
> Готовый комплект обновления существующей 3x-ui 3.8.5: [релиз tunnels-3.8.5-patch3](https://github.com/danilov76/3x-ui/releases/tag/tunnels-3.8.5-patch3). [Установка и откат](docs/tunnels-release-install.md).
